...
class Master extends Component {
  render() {
    const productItems = this.props.products.map((master) => (
      <div className="container" key={master.id}>
        <br />
          ...
          <div className="card mb-8">
            <div className="row no-gutters">
              <div className="col-md-4">
                <br />
                <img
                  src="https://p.ipricegroup.com/1b16d74691897b472a24844b60678978dec6dc35_0.jpg"
                  className="card-img"
                  width="350"
                  height="270"
                  alt={master.title}
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">{master.description}</p>
                  <div className="card-footer bg-white border rounded">
                    <b>{util.formatCurrency(master.price)}</b>
                    <button
                      className="btn btn-secondary"
                      onClick={() =>
                        this.props.addToCart(this.props.cartItems, master)
                      }
                    >
                      <svg
                        width="1em"
...
export default connect(mapStateToProps, { addToCart })(Master);
